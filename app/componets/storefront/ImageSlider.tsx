        ...
        <div className="grid gap-6 md:gap-3 items-start">
            ...
            <div className="grid grid-cols-5 gap-4">
                {images.map((image, index) => (
                    <div className={cn(index === mainImageIndex ? "border-2 border-primary" : "border bprder-gray-200", "relative overflow-hidden rouded-lg cursor-pointer")} key={index} onClick={() =>handleImageClick(index)}>
